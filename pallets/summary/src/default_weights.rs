...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn record_summary_calculation(v: u32, _r: u32, ) -> Weight {
		Weight::from_ref_time(52_677_528)
			// Standard Error: 9_975
			.saturating_add(Weight::from_ref_time(79_914).saturating_mul(v.into()))
	...
	fn approve_root_with_end_voting(v: u32, o: u32, ) -> Weight {
		Weight::from_ref_time(134_910_644)
			// Standard Error: 13_454
			.saturating_add(Weight::from_ref_time(8_685).saturating_mul(v.into()))
			// Standard Error: 65_698
			.saturating_add(Weight::from_ref_time(11_651_495).saturating_mul(o.into()))
	...
	fn approve_root_without_end_voting(v: u32, ) -> Weight {
		Weight::from_ref_time(60_201_385)
			// Standard Error: 8_369
			.saturating_add(Weight::from_ref_time(98_873).saturating_mul(v.into()))
	...
	/// The range of component `o` is `[1, 2]`.
	fn reject_root_with_end_voting(v: u32, o: u32, ) -> Weight {
		Weight::from_ref_time(149_189_500)
			// Standard Error: 24_839
			.saturating_add(Weight::from_ref_time(243_878).saturating_mul(v.into()))
			// Standard Error: 57_731
			.saturating_add(Weight::from_ref_time(12_335_261).saturating_mul(o.into()))
	...
	/// The range of component `v` is `[4, 10]`.
	fn reject_root_without_end_voting(v: u32, ) -> Weight {
		Weight::from_ref_time(56_614_330)
			// Standard Error: 8_478
			.saturating_add(Weight::from_ref_time(94_514).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	/// The range of component `o` is `[1, 2]`.
	fn end_voting_period_with_rejected_valid_votes(v: u32, o: u32, ) -> Weight {
		Weight::from_ref_time(89_542_421)
			// Standard Error: 22_996
			.saturating_add(Weight::from_ref_time(81_004).saturating_mul(v.into()))
			// Standard Error: 53_446
			.saturating_add(Weight::from_ref_time(12_655_389).saturating_mul(o.into()))
			.saturating_add(T::DbWeight::get().reads(9))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(o.into())))
			.saturating_add(T::DbWeight::get().writes(6))
			.saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(o.into())))
	...
	/// The range of component `o` is `[1, 2]`.
	fn end_voting_period_with_approved_invalid_votes(v: u32, o: u32, ) -> Weight {
		Weight::from_ref_time(111_350_925)
			// Standard Error: 23_538
			.saturating_add(Weight::from_ref_time(100_108).saturating_mul(v.into()))
			// Standard Error: 54_708
			.saturating_add(Weight::from_ref_time(12_088_598).saturating_mul(o.into()))
			.saturating_add(T::DbWeight::get().reads(10))
			.saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(o.into())))
	...
	fn advance_slot_with_offence(v: u32, ) -> Weight {
		Weight::from_ref_time(88_790_315)
			// Standard Error: 18_473
			.saturating_add(Weight::from_ref_time(58_330).saturating_mul(v.into()))
	...
	/// The range of component `v` is `[3, 10]`.
	fn advance_slot_without_offence(v: u32, ) -> Weight {
		Weight::from_ref_time(39_134_749)
			// Standard Error: 6_914
			.saturating_add(Weight::from_ref_time(38_502).saturating_mul(v.into()))
	...
	/// The range of component `v` is `[3, 10]`.
	fn add_challenge(v: u32, ) -> Weight {
		Weight::from_ref_time(99_175_522)
			// Standard Error: 15_554
			.saturating_add(Weight::from_ref_time(105_786).saturating_mul(v.into()))
			.saturating_add(T::DbWeight::get().reads(12))
			.saturating_add(T::DbWeight::get().writes(7))
	}
}
