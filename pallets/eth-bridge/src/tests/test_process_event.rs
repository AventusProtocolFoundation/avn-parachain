...
mod process_event {
    use avn::sr25519::AuthorityId;
    use pallet_ethereum_events::{Challenges, ProcessedEvents};
    ...
    impl Default for Context {
        fn default() -> Self {
            ...
            let validator = EthBridge::validators()[0].clone();
            ...
            Context {
                ...
                first_validator_id: EthBridge::validators()[1].account_id.clone(),
                second_validator_id: EthBridge::validators()[2].account_id.clone(),
            ...
            mod and_event_is_executed_successfully {
                ...
                fn logs_ethereum_event_not_processed() {
                    ...
                    ext.execute_with(|| {
                        ...
                        let event =
                            Event::EthBridge(crate::Event::<TestRuntime>::EventProcessed {
                ...
                fn logs_ethereum_event_rejected() {
                    ...
                    ext.execute_with(|| {
                        ...
                        let event =
                            Event::EthBridge(crate::Event::<TestRuntime>::EventRejected {
                                eth_event_id: context.event_id,
                ...
                fn logs_offence_reported() {
                    ...
                    ext.execute_with(|| {
                        ...
                        let event =
                            Event::EthBridge(crate::Event::<TestRuntime>::OffenceReported {
                                offence_type:
                ...
                fn creates_offence_for_check_creator() {
                    ...
                    ext.execute_with(|| {
                        ...
                        let offences = ETHOFFENCES.with(|l| l.replace(vec![]));
                        assert_eq!(
                            offences,
                            vec![(
            ...
            mod and_event_is_executed_successfully {
                ...
                fn logs_ethereum_event_accepted() {
                    ...
                    ext.execute_with(|| {
                        ...
                        let event =
                            Event::EthBridge(crate::Event::<TestRuntime>::EventAccepted {
                                eth_event_id: context.event_id,
                            });
                        assert_eq!(true, an_event_was_emitted(&event));
                    });
    ...
    fn setup_preconditions(context: &Context) {
        ...
        assert_eq!(EthBridge::events_pending_challenge().len(), 1);
    ...
    fn call_process_event_result(context: &Context) -> DispatchResultWithPostInfo {
        let process_event_result = EthBridge::process_event(
            RawOrigin::None.into(),
    ...
    fn setup_successful_challenge(check_result: CheckResult) -> Context {
        ...
        assert_eq!(true, EthBridge::is_challenge_successful(&context.check_result));
    ...
    fn setup_failing_challenge(check_result: CheckResult) -> Context {
        ...
        setup_preconditions(&context);
        add_challenge(&context);
        assert_eq!(false, EthBridge::is_challenge_successful(&context.check_result));
    ...
    fn setup_without_challenge(check_result: CheckResult) -> Context {
        ...
        setup_preconditions(&context);
        assert!(!EthBridge::is_challenge_successful(&context.check_result));

        return context
    }

    fn there_are_no_pending_events() -> bool {
        return EthBridge::events_pending_challenge().len() == 0
    }
